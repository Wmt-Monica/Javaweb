package javawebStage.jDBC.reflection.inner;
...
public class ReflectionInner {
    ...
    public void test1() throws ClassNotFoundException {
        ...
        System.out.println(Class.forName("javawebStage.jDBC.reflectionInner.ReflectionInner$inner1"));
        /*
        ...
        int constructionMethodCount = Class.forName(
                "javawebStage.jDBC.reflectionInner.ReflectionInner$inner1").getConstructors().length;
    ...
    public void test2() throws ClassNotFoundException, IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        System.out.println(c1.getName());
        System.out.println(Class.forName("javawebStage.jDBC.reflectionInner.ReflectionInner$inner2"));
        int constructionMethodCount = Class.forName(
                "javawebStage.jDBC.reflectionInner.ReflectionInner$inner2").getConstructors().length;
        ...
        int constructionMethodCount2 = Class.forName(
                "javawebStage.jDBC.reflectionInner.ReflectionInner$inner2").getDeclaredConstructors().length;
        ...
        System.out.println(Class.forName(
                "javawebStage.jDBC.reflectionInner.ReflectionInner$inner2")
    ...
    public void test3() throws ClassNotFoundException, IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        System.out.println(Class.forName("javawebStage.jDBC.reflectionInner.ReflectionInner$inner3"));
        int constructionMethodCount = Class.forName(
                "javawebStage.jDBC.reflectionInner.ReflectionInner$inner3").getDeclaredConstructors().length;
        ...
        System.out.println(Class.forName(
                "javawebStage.jDBC.reflectionInner.ReflectionInner$inner3")
