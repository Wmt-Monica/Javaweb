...
public class selectData {
    ...
    @Test
    public void selectRunning() throws SQLException, NoSuchFieldException, IllegalAccessException {
        // 1.创建有关查询的 SQL　字符串对象
//        String sql = "select * from student where stu_name = '王梦婷'";
        String sql = "select stu_name,stu_birthday from student";
        String sql1 = "select * from student";
        new selectData().select(sql);
        System.out.println("--------------------------------------------------------------------");
        new selectData().select(sql1);
    }


    public void select2(String sql) throws SQLException, NoSuchFieldException, IllegalAccessException {
        // 2.创建 PreparedStatement 对象并执行 SQL 查询
        PreparedStatement pre = conn.prepareStatement(sql);
    ...
    @Test
    public void selectRunning2() throws NoSuchFieldException, IllegalAccessException, SQLException {
        String sql2 = "select teacher_id teacherID, teacher_name teacherName from teacher";
        new selectData().select2(sql2);
    }
